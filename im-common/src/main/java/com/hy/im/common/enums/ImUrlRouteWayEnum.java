...
public enum ImUrlRouteWayEnum {
     ...
     * 随机
     */
    RAMDOM(1,"com.hy.im.common.route.algorithm.random.RandomHandle"),


    /**
     * 轮训
     */
    LOOP(2,"com.hy.im.common.route.algorithm.loop.LoopHandle"),

    /**
     * HASH
     */
    HASH(3,"com.hy.im.common.route.algorithm.consistenthash.ConsistentHashHandle"),
    ;
