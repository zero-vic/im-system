...
import com.hy.im.message.service.StoreMessageService;
...
public class StroeGroupMessageReceiver {
    ...
    @RabbitListener(
            bindings = @QueueBinding(
                    value = @Queue(value = RabbitConstants.STORE_GROUP_MESSAGE,durable = "true"),
                    exchange = @Exchange(value = RabbitConstants.STORE_GROUP_MESSAGE,durable = "true")
            ),concurrency = "1"
    )
