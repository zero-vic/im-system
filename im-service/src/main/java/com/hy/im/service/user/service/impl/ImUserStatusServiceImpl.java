package com.hy.im.service.user.service.impl;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.hy.im.codec.pack.user.UserCustomStatusChangeNotifyPack;
...
import com.hy.im.service.util.UserSessionUtils;
...
public class ImUserStatusServiceImpl implements ImUserStatusService {
    ...
    private void dispatcher(Object pack,String userId,Integer appId){
        ...
        String userKey = appId + ":" + RedisConstants.SUB_SCRIBE + userId;
    ...
    public void subscribeUserOnlineStatus(SubscribeUserOnlineStatusReq req) {
        ...
        for (String beSubUserId : req.getSubUserId()) {
            String userKey = req.getAppId() + ":" + RedisConstants.SUB_SCRIBE + ":" + beSubUserId;
